...
const AppDetails = () => {
    ...
    const { companyName, title, description, image, downloads, ratingAvg, reviews, size } = singleApp;

    return (
        <>
            <div className="flex flex-col md:flex-row md:gap-15 md:w-7xl w-2xl  mx-auto my-6 ">
                ...
                <div className='md:w-2xl'>
                    ...
                    <h2 className="text-gray-600 mt-2">Developed By : <span className='text-indigo-600 font-semibold'> {companyName}</span></h2>
                    <hr className='my-3 text-gray-400' />
                    <div className='flex flex-col md:flex-row gap-10'>
                        <div>
                            <Download className='text-green-600 text-2xl font-bold'></Download>
                            <p>Downloads</p>
                        ...
                        <div>
                            <ThumbsUp className='text-blue-600'></ThumbsUp>
                            <p>Total Reviews</p>
                            <h2 className='text-2xl font-bold '>{reviews}</h2>
                        </div>
                    </div>
                    <div className='text-center py-2 rounded-lg mt-4 bg-green-400 w-[160px]'>
                        <button className='text-white'>Install Now ( {size} MB)</button>
                    </div>
                </div>
            </div>
           
            {/* description section  */}
            <section className='w-2xl md:w-7xl mx-auto'>
            <hr className='my-3 text-gray-400' />
